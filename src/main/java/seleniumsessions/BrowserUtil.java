...
public class BrowserUtil {
	...
	public void checkBlankUrl(String url) {
		if (url.length() == 0) {
	...
	/**
	 * This method is used to return page title
	 * 
	 * @return
	 */
	...
	public boolean getUrlFraction(String urlFraction) {
	...
	public boolean isInfoExistInPage(String info) {
